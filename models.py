...
class WardrobeItem(Base):
    ...
    user = relationship("User", back_populates="wardrobe", primaryjoin="WardrobeItem.user_id == User.user_id")
...
class Look(Base):
    ...
    items_ids = Column(Text)  # CSV or JSON
    occasion = Column(String, nullable=True)
    created_at = Column(DateTime, default=datetime.utcnow)

    user = relationship("User", back_populates="looks", primaryjoin="Look.user_id == User.user_id")
...
class Analysis(Base):
    ...
    user = relationship("User", back_populates="analyses", primaryjoin="Analysis.user_id == User.user_id")
